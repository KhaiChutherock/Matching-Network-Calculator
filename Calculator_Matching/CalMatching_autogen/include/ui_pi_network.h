/********************************************************************************
** Form generated from reading UI file 'pi_network.ui'
**
...
#ifndef UI_PI_NETWORK_H
#define UI_PI_NETWORK_H
...
public:
    ...
    void setupUi(QDialog *pi_network)
    {
        if (pi_network->objectName().isEmpty())
            pi_network->setObjectName("pi_network");
        pi_network->resize(800, 600);
        QPalette palette;
        ...
        pi_network->setPalette(palette);
        circuit = new QLabel(pi_network);
        circuit->setObjectName("circuit");
        circuit->setGeometry(QRect(450, 380, 350, 170));
        circuit->setLayoutDirection(Qt::LeftToRight);
        circuit->setPixmap(QPixmap(QString::fromUtf8(":/image/pi.jpg")));
        circuit->setScaledContents(true);
        gridLayoutWidget = new QWidget(pi_network);
        gridLayoutWidget->setObjectName("gridLayoutWidget");
        gridLayoutWidget->setGeometry(QRect(170, 80, 451, 241));
        ...
        gridLayoutWidget_2 = new QWidget(pi_network);
        ...
        retranslateUi(pi_network);

        calculateButton->setDefault(false);


        QMetaObject::connectSlotsByName(pi_network);
    } // setupUi

    void retranslateUi(QDialog *pi_network)
    {
        pi_network->setWindowTitle(QCoreApplication::translate("pi_network", "Pi_Match", nullptr));
        circuit->setText(QString());
        label_4->setText(QCoreApplication::translate("pi_network", "Circuit DC Current (Ohm):", nullptr));
        label_3->setText(QCoreApplication::translate("pi_network", "Frequency (MHz):", nullptr));
        label_9->setText(QCoreApplication::translate("pi_network", "Source Resistance (Ohm): ", nullptr));
        label_6->setText(QCoreApplication::translate("pi_network", "Load Resistance (Ohm):", nullptr));
        DCcurrent->setItemText(0, QCoreApplication::translate("pi_network", "DC Feed", nullptr));
        DCcurrent->setItemText(1, QCoreApplication::translate("pi_network", "DC Block", nullptr));

        label_5->setText(QCoreApplication::translate("pi_network", "Q Factor:", nullptr));
        Val2->setText(QCoreApplication::translate("pi_network", "CS (nF):", nullptr));
        Val1->setText(QCoreApplication::translate("pi_network", "L (uH):                  ", nullptr));
        Val3->setText(QCoreApplication::translate("pi_network", "CL (nF):", nullptr));
        calculateButton->setText(QCoreApplication::translate("pi_network", "Calculate", nullptr));
        label->setText(QCoreApplication::translate("pi_network", "Pi-Match Impedance Matching Circuits", nullptr));
    } // retranslateUi

};

namespace Ui {
    class pi_network: public Ui_pi_network {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PI_NETWORK_H
